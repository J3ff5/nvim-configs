...
_G.packer_plugins = {
  ["coc.nvim"] = {
    loaded = true,
    path = "/home/jeff/.local/share/nvim/site/pack/packer/start/coc.nvim",
    url = "https://github.com/neoclide/coc.nvim"
  },
  harpoon = {
    loaded = true,
    path = "/home/jeff/.local/share/nvim/site/pack/packer/start/harpoon",
  ...
  playground = {
    loaded = true,
    path = "/home/jeff/.local/share/nvim/site/pack/packer/start/playground",
  ...
  ["rose-pine"] = {
    ...
    loaded = true,
    path = "/home/jeff/.local/share/nvim/site/pack/packer/start/rose-pine",
  ...
  undotree = {
    loaded = true,
    path = "/home/jeff/.local/share/nvim/site/pack/packer/start/undotree",
    url = "https://github.com/mbbill/undotree"
  },
  ["vim-fugitive"] = {
    loaded = true,
    path = "/home/jeff/.local/share/nvim/site/pack/packer/start/vim-fugitive",
